...
public class TransManageTabFragmentDelivering extends Fragment implements AbsListView.OnScrollListener,ResultInString {
    ...
    ListAdapter adapter;
    ArrayList<GtStTransManageDeliveredList> gtStTransManageDeliveredLists;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        gtStTransManageDeliveredLists = new ArrayList<>();
        gtStTransManageDeliveredLists = SlgnTransManageGetDeliveredList.getInstance().gtStTransManageDeliveredLists;
        ...
        adapter = new TransManageCustomDeliveredListAdapter(getActivity(),gtStTransManageDeliveredLists);
