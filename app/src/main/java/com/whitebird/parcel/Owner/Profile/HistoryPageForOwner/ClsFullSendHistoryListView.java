...
public class ClsFullSendHistoryListView extends AppCompatActivity {

    ArrayList<ItemsInListSend> arrayList;
    int position;
    ItemsInListSend itemsInList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cls_full_history_list_view);
        ...
        TextView textViewSenderAddress = (TextView)findViewById(R.id.owner_history_send_model_full_edit_sender_address);
        TextView textViewSenderName = (TextView)findViewById(R.id.owner_history_send_model_full_edit_sender_name);
        TextView textViewSenderMo = (TextView)findViewById(R.id.owner_history_send_model_full_edit_sender_mob);
        TextView textViewReceiverName = (TextView)findViewById(R.id.owner_history_send_model_full_edit_receiver_name);
        TextView textViewReceiverMo = (TextView)findViewById(R.id.owner_history_send_model_full_edit_receiver_mob);
        TextView textViewSize = (TextView)findViewById(R.id.owner_history_send_model_full_edit_size);
        TextView textViewWeight = (TextView)findViewById(R.id.owner_history_send_model_full_edit_weight);
        TextView textViewTimeline = (TextView)findViewById(R.id.owner_history_send_model_full_edit_timeline);
        TextView textViewType = (TextView)findViewById(R.id.owner_history_send_model_full_edit_type);
        TextView textViewAddress = (TextView)findViewById(R.id.owner_history_send_model_full_edit_address);
        TextView textViewOrderNo = (TextView)findViewById(R.id.owner_history_send_model_full_edit_order_no);
        TextView textViewDispTime = (TextView)findViewById(R.id.owner_history_send_model_full_edit_disp_time);
        ...
        ImageView imageView = (ImageView)findViewById(R.id.owner_image_full_owner_history_send_list);
